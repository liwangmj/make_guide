...
set(CMAKE_EXE_LINKER_FLAGS_DEBUG "${CMAKE_EXE_LINKER_FLAGS_DEBUG} -Wl,-install_name,@rpath/ -Wl,-rpath,@loader_path,-rpath,@executable_path,-rpath,${APPOUTPATH},-rpath,${DLLOUTPATH},-rpath,${LIBOUTPATH}")
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -O2 -Wall")
set(CMAKE_CXX_FLAGS_RELEASE "${CMAKE_CXX_FLAGS_RELEASE} -O2 -Wall")
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "${CMAKE_EXE_LINKER_FLAGS_RELEASE} -Wl,-install_name,@rpath/ -Wl,-rpath,@loader_path,-rpath,@executable_path,-rpath,./,-rpath,./lib/,-rpath,./plugin/")
