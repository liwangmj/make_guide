...
cmake -DCPLATFORM=win32 -DCCPU=x86 -DCCOMPILE=msvc2010 -DCVER=release -G"Visual Studio 10" -DCMAKE_BUILD_TYPE=Release -DCMAKE_CONFIGURATION_TYPES=release ..\..\cmake
