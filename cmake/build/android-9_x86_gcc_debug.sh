...
mkdir -p ${PWD}/../../build/cmake_android-9_x86_gcc_debug/
cd ${PWD}/../../build/cmake_android-9_x86_gcc_debug/
rm -rf *
...
cmake -DCPLATFORM=android-9 -DCCPU=x86 -DCCOMPILE=gcc -DCVER=debug -DANDROID_NATIVE_API_LEVEL="android-9" -DANDROID_ABI="x86" -DCMAKE_BUILD_TYPE=Debug -DCMAKE_TOOLCHAIN_FILE=../../cmake/toolchain/android.toolchain.cmake ../../cmake
#make -j8
cmake --build .
