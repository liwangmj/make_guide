...
cmake -DCPLATFORM=android-9 -DCCPU=armeabi-v7a -DCCOMPILE=gcc -DCVER=release -DANDROID_NATIVE_API_LEVEL="android-9" -DANDROID_ABI="armeabi-v7a with NEON" -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=../../cmake/toolchain/android.toolchain.cmake ../../cmake
#make -j8
cmake --build .
